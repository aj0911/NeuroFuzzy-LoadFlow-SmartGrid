...
\usepackage{fancyhdr}
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows.meta, positioning, er}
\usepackage{siunitx}
\usepackage{setspace}
\usepackage{amssymb}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Final Year B.Tech Project Report}
...
\newcommand{\rolltwo}{2K22/EE/34}
\newcommand{\authorthree}{Akshat Garg}
\newcommand{\rollthree}{2K22/EE/33}
...
\begin{titlepage}
    ...
    \vspace{2mm}
    {\normalsize SUBMITTED IN PARTIAL FULFILLMENT OF THE REQUIREMENTS\par}
    \vspace{1mm}
    {\normalsize FOR THE AWARD OF THE DEGREE OF\par}
    ...
    \vspace{2mm}
    {\large\bfseries \authorone~(Roll No. \rollone)\par}
    {\large\bfseries \authortwo~(Roll No. \rolltwo)\par}
    {\large\bfseries \authorthree~(Roll No. \rollthree)\par}
    ...
    % DTU Logo (kept exactly where you placed it)
    \includegraphics[width=30mm]{DTU_Official_logo.png}
    
    \vspace{6mm}
    {\normalsize\bfseries \MakeUppercase{\department}\par}
    {\large DELHI TECHNOLOGICAL UNIVERSITY\par}
    {\normalsize Bawana Road, Delhi-110042\par}
    \vspace{6mm}
    {\large\bfseries NOV, 2025}
    \vfill
...
We are grateful to \textbf{Dr. Rachna Garg}, Head of the Department of Electrical Engineering, for providing us with the necessary facilities and resources to carry out this project.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/architecture/fig4_model_pipeline.png}
\caption{Complete System Architecture and Pipeline}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/architecture/fig3_fuzzy_membership.png}
\caption{Fuzzy Membership Functions for Input and Output Variables}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/architecture/fig10_system_topology.png}
\caption{IEEE 33-Bus Radial Distribution System Topology}
...
def preprocess_input(self, X_sensor, X_fuzzy):
    #Preprocess inputs: impute missing values, create masks, normalize, and concatenate features.
...
\begin{lstlisting}[caption={Vercel Configuration}]
{
  "version": 2,
  "builds": [
    {
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/data-analysis/fig1_dataset_overview.png}
\caption{Dataset Overview: Distribution of Sparsity Levels and Key Statistics}
\label{fig:dataset_overview}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/data-analysis/fig2_voltage_analysis.png}
\caption{Voltage Distribution Analysis Across All Buses}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/training/fig5_training_curves.png}
\caption{Training and Validation Loss Curves for Neuro-Fuzzy and Baseline Models}
\label{fig:training_curves}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{results/training_history.png}
\caption{Detailed Training History with Learning Rate Schedule}
\label{fig:training_history_detailed}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{results/prediction_comparison.png}
\caption{Prediction vs. Ground Truth Comparison for Voltage Magnitudes and Phase Angles}
\label{fig:prediction_comparison}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{results/error_analysis.png}
\caption{Error Distribution Analysis and Residual Plots}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/model-performance/fig6_performance_analysis.png}
\caption{Comprehensive Performance Analysis Across Multiple Metrics}
\label{fig:performance_analysis}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/comparisons/fig8_model_comparison.png}
\caption{Model Comparison: Neuro-Fuzzy vs. Baseline Approaches}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/model-performance/fig7_sparsity_impact.png}
\caption{Impact of Sensor Sparsity on Prediction Accuracy}
\label{fig:sparsity_impact}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{results/sparsity_impact.png}
\caption{Detailed Sparsity Analysis: MAE Variation Across Different Sparsity Levels}
\label{fig:sparsity_detailed}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{figures/comparisons/fig9_feature_importance.png}
\caption{Feature Importance Ablation Study Results}
\label{fig:feature_importance}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{results/fuzzy_feature_distributions.png}
\caption{Distribution of Fuzzy Feature Values Across Dataset}
\label{fig:fuzzy_distributions}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.95\textwidth]{results/fuzzy_membership_functions.png}
\caption{Fuzzy Membership Functions Visualization with Sample Data Points}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/data-analysis/02_voltage_distribution.png}
\caption{Detailed Voltage Distribution Across All 33 Buses}
\label{fig:voltage_distribution_appendix}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/data-analysis/03_angle_distribution.png}
\caption{Phase Angle Distribution Across All 33 Buses}
\label{fig:angle_distribution_appendix}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/data-analysis/04_correlation_analysis.png}
\caption{Correlation Analysis Between Input Features and Output States}
\label{fig:correlation_appendix}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/data-analysis/05_input_characteristics.png}
\caption{Input Feature Characteristics and Statistical Properties}
\label{fig:input_characteristics}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/data-analysis/06_statistical_summary.png}
\caption{Comprehensive Statistical Summary of Dataset Features}
